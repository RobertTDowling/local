...
int init_fb ()
{
 ...
 got_res:
printf("Got_res: hsize %d, vsize %d\n", hsize, vsize);
...
printf("Map: hsize %d, vsize %d\n", hsize, vsize);
...
#if 1	// 14sep11
	printf ("hstride=%d vstride=%d w=%d h=%d\n", 
	 		 hstride, vstride, hsize, vsize);
#endif
 	dc = (unsigned char*)fb;
	return 0;
 ...
 try2:
	...
	// Query varinfo xres, yres for screen size
	hsize = vinfo.xres;
	vsize = vinfo.yres;
	printf("Try2: hsize %d, vsize %d\n", hsize, vsize);
